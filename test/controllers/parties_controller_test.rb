...
class PartiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create party" do
    assert_difference('Party.count') do
      post parties_url, params: { party: { name: @party.name, submission_id: @party.submission_id, votes: @party.votes } }, as: :json
    end
  ...
  test "should update party" do
    patch party_url(@party), params: { party: { name: @party.name, submission_id: @party.submission_id, votes: @party.votes } }, as: :json
    assert_response 200
  end
